...
function loadEvents() {
    console.log("Inizio caricamento CSV..."); // Aggiunto per verificare che il CSV stia per essere caricato
    Papa.parse('https://raw.githubusercontent.com/loressm/provasito/refs/heads/master/eventi.csv', {
        download: true,
        header: true,
        dynamicTyping: true,
        complete: function(results) {
            console.log(results); // Log per debug: vedi i risultati del CSV
